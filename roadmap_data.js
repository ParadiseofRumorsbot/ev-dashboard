...
const ROADMAP = {
  ...
  oems: {
    ...
    /* BMW — 2026-09-03 추가. Marklines 모델플랜 DB(유료) 미열람 → Marklines 공개뉴스(i3 뮌헨 양산 8/6 · iX3 L 사전주문 9/3)
       + BMW 보도자료 + 업계매체(electrive·CnEVPost·WardsAuto·BMWBlog) 재구성. 연도 = 인도 개시 기준(SOP≠출시 시 인도 기준).
       괄호 = 세대 구분만: (1세대)=Gen5·CLAR/FAAR 기반, (2세대)=Neue Klasse·Gen6. 트림(iX3 40·30L LFP·M60L 등)은 제외.
       BMW 공식 발표가 아닌 매체 보도 기반 항목: iX4 시점, iM3, i3 Touring, i5 facelift(2027), iX1 2세대(SOP 2027.11), iX5 M, i4 2세대, i5 2세대(2029E) */
    BMW: {
      label: "BMW", flag: "🇩🇪", regions: ["북미","유럽","중국"],
      note: "괄호 = BMW BEV 세대 구분(1세대=Gen5·CLAR/FAAR 기반, 2세대=Neue Klasse·Gen6) · 연도 = 인도 개시 기준 · 출처: Marklines 공개뉴스·BMW 보도자료·업계매체 재구성(2026.09.03)",
      sched: {
        "2021": {"유럽":["iX3 (1세대)","iX3 facelift (1세대)","iX (1세대)","i4 (1세대)"], "중국":["iX3 facelift (1세대)","iX (1세대)"]},
        "2022": {"북미":["iX (1세대)","i4 (1세대)","i7 (1세대)"], "유럽":["i7 (1세대)","iX1 (1세대)"], "중국":["i4 (1세대)","i3 LWB (1세대)","i7 (1세대)"]},
